document.addEventListener('DOMContentLoaded', () => {
  ...
  const uiDict = {
    ...
    mg: {
      appTitle: 'Kalandrier litorjika ortodoksa',
      chooseDate: 'Fidio daty :',
      show: 'Asehoy',
      loading: 'Fandaharana...',
      fast: 'Fady',
      level: 'Ambaratonga',
      exception: 'Maningana',
      saints: 'Olo-masina androany',
      info: 'Fampahalalana fanampiny',
      paschaDistance: 'Halavirana amin\'ny Paska',
      notes: 'Fanamarika',
      readings: 'Vakiteny androany',
      stories: 'Tantaran\'ny olo-masina',
      noData: 'Tsy misy fampahalalana ho an\'ity daty ity.',
      tone: 'Ton',
      chapter: 'Tokony',
      feastsTitle: 'Fety',
